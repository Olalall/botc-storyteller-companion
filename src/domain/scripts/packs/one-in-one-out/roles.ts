...
export const oneInOneOutRoles: readonly SmartRoleDefinition[] = [
  ...
  role({ id: 'recluse', name: '陌客', officialName: 'Recluse', team: 'outsider', abilityText: 'You might register as evil & as a Minion or Demon, even if dead.', inputKinds: ['none'], possibleOutcomes: ['可能被登记为邪恶、爪牙或恶魔。'], highRiskNotes: ['登记异常由说书人裁量。'] }),
  ...
  role({ id: 'mezepheles', name: '灵言师', officialName: 'Mezepheles', team: 'minion', abilityText: 'You start knowing a secret word. The 1st good player to say this word becomes evil that night.', inputKinds: ['text'], possibleOutcomes: ['首个说出暗号的善良玩家当晚变邪恶。'], teamChanges: ['首个说出暗号的善良玩家当晚变为邪恶。'], playerMessageTemplates: ['你的暗号是：{word}。'], highRiskNotes: ['受圣洁之魂额外邪恶限制；变邪恶必须由说书人确认并追加记录。'] }),
  ...
  role({ id: 'spiritofivory', name: '圣洁之魂', officialName: 'Spirit of Ivory', team: 'fabled', abilityText: "There can't be more than 1 extra evil player.", inputKinds: ['none'], setupImpact: ['额外邪恶玩家不能超过 1 名。'], possibleOutcomes: ['限制灵言师、食人魔等额外邪恶变化。'], highRiskNotes: ['传奇角色只作为全局约束，不进入座位身份池，也不作为恶魔伪装。'] }),
]
