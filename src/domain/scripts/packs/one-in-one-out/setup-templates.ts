...
export const oneInOneOutSetupTemplates: readonly SetupTemplate[] = [
  ...
  template({ id: 'ten-fanggu-flow', count: 10, style: 'chaos', roles: ['knight', 'highpriestess', 'snakecharmer', 'oracle', 'fisherman', 'farmer', 'ogre', 'harpy', 'mezepheles', 'fanggu'], bluffs: ['steward', 'seamstress', 'cannibal'], note: 'One in one out 10 人模板：方古 10 人加外来者，配合灵言师但受象牙之灵限制提醒。', fangGuAddsOutsider: true }),
