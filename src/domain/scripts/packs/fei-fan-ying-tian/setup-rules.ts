...
export const feiFanYingTianSetupRules: readonly SetupRule[] = [
  ...
  { id: "alchemist-minion-ability", roleId: "alchemist", summary: "Alchemist receives an out-of-play Minion ability; effects remain ST-confirmed.", knowledgeStatus: 'confirmed', sourceUrls: [sourceUrl], reviewedAt },
