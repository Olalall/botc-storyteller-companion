...
export const troubleBrewingRoles: readonly SmartRoleDefinition[] = [
  ...
  role({"id":"undertaker","name":"送葬者","officialName":"Undertaker","team":"townsfolk","abilityText":"Each night*, you learn which character died by execution today.","inputKinds":["role"],"possibleOutcomes":["告知今天被处决玩家的角色。"],"playerMessageTemplates":["你得知：今天被处决的玩家是{roleName}。"],"highRiskNotes":["只处理处决死亡，不处理夜晚死亡或替换死亡。"]}),
  ...
  role({"id":"virgin","name":"贞洁者","officialName":"Virgin","team":"townsfolk","abilityText":"The 1st time you are nominated, if the nominator is a Townsfolk, they are executed immediately.","inputKinds":["none"],"possibleOutcomes":["当贞洁者首次被提名时，如果提名者是镇民，提名者立刻被处决。","无论提名者是谁，首次被提名后贞洁者即失去能力，即使提名者没有死亡，或者贞洁者处于醉酒或中毒状态。"],"stateChanges":["可能立即处决提名者。"],"highRiskNotes":["确认提名者实际是否镇民，再决定是否触发。"]}),
  role({"id":"butler","name":"管家","officialName":"Butler","team":"outsider","abilityText":"Each night, choose a player (not yourself): tomorrow, you may only vote if they are voting too.","inputKinds":["player"],"stateChanges":["明天投票受主人限制（流放表决除外，管家可以在流放表决中自由参与表决）。"],"highRiskNotes":["记录选择即可，投票合法性由说书人提醒。"]}),
  ...
  role({"id":"recluse","name":"陌客","officialName":"Recluse","team":"outsider","abilityText":"You might register as evil & as a Minion or Demon, even if dead.","inputKinds":["none"],"possibleOutcomes":["可能被登记为邪恶、爪牙或恶魔。"],"highRiskNotes":["登记结果是说书人自由裁量，不要让 AI 自动定死。"]}),
  role({"id":"saint","name":"圣徒","officialName":"Saint","team":"outsider","abilityText":"If you die by execution, your team loses.","inputKinds":["none"],"possibleOutcomes":["若圣徒死于处决，其阵营落败。"],"stateChanges":["死于处决才会触发落败；被处决但没有死亡（如替罪羊代替被处决）时不触发。"],"highRiskNotes":["胜负必须由说书人确认。"]}),
  ...
  role({"id":"scarletwoman","name":"红唇女郎","officialName":"Scarlet Woman","team":"minion","abilityText":"If there are 5 or more players alive & the Demon dies, you become the Demon. (Travellers don't count.)","inputKinds":["none"],"identityChanges":["5 名及以上存活时，恶魔死亡后可能变成恶魔。"],"teamChanges":["成为新的恶魔。"],"highRiskNotes":["是否触发需要确认存活人数和恶魔死亡方式。"]}),
  ...
  role({"id":"bureaucrat","name":"官员","officialName":"Bureaucrat","team":"traveler","abilityText":"Each night, choose a player (not yourself): their vote counts as 3 votes tomorrow.","inputKinds":["player"],"stateChanges":["被选择的玩家明天白天的投票算作三票。"],"highRiskNotes":["流放表决不会受到能力的影响，被官员选择的玩家在流放表决中正常计票，而不是计3票。","官员死后或者被流放后会失去他的能力，被官员选择的玩家会立刻恢复为计1票。"]}),
  role({"id":"gunslinger","name":"枪手","officialName":"Gunslinger","team":"traveler","abilityText":"Each day, after the 1st vote has been tallied, you may choose a player that voted: they die.","inputKinds":["player"],"highRiskNotes":["流放表决不算作首次投票，且枪手不能选择支持流放表决的投票者。"]}),
