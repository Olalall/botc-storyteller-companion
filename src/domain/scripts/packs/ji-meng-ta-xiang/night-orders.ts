...
export const jiMengTaXiangOtherNight: readonly NightOrderEntry[] = [
  ...
  { roleId: "acrobat", order: 2000, note: "唤醒杂技演员，让他选择一名玩家。如果当晚这名玩家醉酒或中毒，杂技演员死亡。", knowledgeStatus: 'confirmed' },
  ...
  { roleId: "kazali", order: 7700, note: "唤醒卡扎力，让他攻击一名玩家。", knowledgeStatus: 'confirmed' },
  ...
  { roleId: "jianning", order: 8400, note: "唤醒奸佞，让他攻击一名玩家。随后，唤醒被标记“爪牙死亡”的玩家，让他攻击一名玩家。", knowledgeStatus: 'confirmed' },
