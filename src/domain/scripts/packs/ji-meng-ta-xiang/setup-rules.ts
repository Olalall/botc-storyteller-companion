...
export const jiMengTaXiangSetupRules: readonly SetupRule[] = [
  ...
  { id: "plaguedoctor-st-minion-ability", roleId: "plaguedoctor", summary: "When Plague Doctor dies, ST gains an out-of-play Minion ability; not a player state mutation.", knowledgeStatus: 'confirmed', sourceUrls: [sourceUrl], reviewedAt },
  { id: "barber-death-swap", roleId: "barber", summary: "Barber death can allow Demon to swap two non-Demon characters that night; identity changes are manual.", knowledgeStatus: 'confirmed', sourceUrls: [sourceUrl], reviewedAt },
  { id: "gudiao-poison-registration", roleId: "gudiao", summary: "Gudiao marker poisons next living good player and may register them evil/Minion; marker/status are manual.", knowledgeStatus: 'confirmed', sourceUrls: [sourceUrl], reviewedAt },
  ...
  { id: "jianning-double-action", roleId: "jianning", summary: "Jianning can act twice if she did not vote today; availability and deaths remain ST-confirmed.", knowledgeStatus: 'confirmed', sourceUrls: [sourceUrl], reviewedAt },
  { id: "hundun-mass-poison", roleId: "hundun", summary: "Hundun killing neighboring Townsfolk poisons all good players until next dusk; status remains manual.", knowledgeStatus: 'confirmed', sourceUrls: [sourceUrl], reviewedAt },
