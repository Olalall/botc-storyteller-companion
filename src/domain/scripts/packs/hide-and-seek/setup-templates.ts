...
export const hideAndSeekSetupTemplates: readonly SetupTemplate[] = [
  ...
  template({ id: 'huntsman-damsel', count: 7, style: 'balanced', roles: ['pixie', 'dreamer', 'huntsman', 'ravenkeeper', 'damsel', 'cerenovus', 'pukka'], bluffs: ['noble', 'oracle', 'seamstress'], note: 'Hide & Seek 7 人巡山人模板：落难少女在场，救援与疯狂链路只做提醒。', huntsmanAddsDamsel: true }),
  ...
  template({ id: 'vigormortis-clean', count: 8, style: 'long-game', roles: ['noble', 'pixie', 'preacher', 'towncrier', 'seamstress', 'ravenkeeper', 'poisoner', 'vigormortis'], bluffs: ['librarian', 'undertaker', 'artist'], note: 'Hide & Seek 8 人亡骨魔模板：无外来者，爪牙死亡后的中毒只做提醒。', vigormortisRemovesOutsider: true }),
  ...
  template({ id: 'ten-huntsman', count: 10, style: 'balanced', roles: ['noble', 'oracle', 'dreamer', 'seamstress', 'huntsman', 'ravenkeeper', 'damsel', 'mezepheles', 'poisoner', 'pukka'], bluffs: ['librarian', 'undertaker', 'artist'], note: 'Hide & Seek 10 人巡山人模板：救援落难少女后只追加身份更正，不自动替换。', huntsmanAddsDamsel: true }),
  ...
  template({ id: 'eleven-vigormortis', count: 11, style: 'long-game', roles: ['noble', 'pixie', 'preacher', 'towncrier', 'seamstress', 'artist', 'ravenkeeper', 'virgin', 'poisoner', 'cerenovus', 'vigormortis'], bluffs: ['librarian', 'oracle', 'dreamer'], note: 'Hide & Seek 11 人亡骨魔模板：外来者减少，爪牙保留能力与邻座中毒需手动记录。', vigormortisRemovesOutsider: true }),
  ...
  template({ id: 'twelve-vigormortis', count: 12, style: 'long-game', roles: ['noble', 'librarian', 'pixie', 'preacher', 'towncrier', 'seamstress', 'artist', 'virgin', 'goon', 'mezepheles', 'poisoner', 'vigormortis'], bluffs: ['oracle', 'dreamer', 'ravenkeeper'], note: 'Hide & Seek 12 人亡骨魔模板：莽夫阵营变化和邻座中毒必须分开记录。', vigormortisRemovesOutsider: true }),
  ...
  template({ id: 'thirteen-huntsman', count: 13, style: 'chaos', roles: ['librarian', 'seamstress', 'artist', 'huntsman', 'ravenkeeper', 'virgin', 'noble', 'damsel', 'mutant', 'godfather', 'poisoner', 'cerenovus', 'ojo'], bluffs: ['pixie', 'towncrier', 'oracle'], note: 'Hide & Seek 13 人巡山人模板：双外来者和奥赫增加压力，救援成功要追加更正。', huntsmanAddsDamsel: true, godfatherAddsOutsider: true }),
