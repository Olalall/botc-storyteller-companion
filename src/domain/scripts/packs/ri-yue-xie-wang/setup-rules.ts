...
export const riYueXieWangSetupRules: readonly SetupRule[] = [
  ...
  { id: 'baojun-night-death-count', roleId: 'baojun', summary: 'Baojun cannot choose the same number of kills as the previous night death count, with counts above two treated as two.', knowledgeStatus: 'confirmed', sourceUrls: [sourceUrl], reviewedAt },
