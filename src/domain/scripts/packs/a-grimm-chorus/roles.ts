...
export const aGrimmChorusRoles: readonly SmartRoleDefinition[] = [
  ...
  role({ id: 'scarletwoman', name: '猩红女郎', officialName: 'Scarlet Woman', team: 'minion', abilityText: "If there are 5 or more players alive & the Demon dies, you become the Demon. (Travellers don't count.)", identityChanges: ['5 名及以上存活时，恶魔死亡后可能变成恶魔。'], teamChanges: ['成为新的恶魔。'], highRiskNotes: ['是否触发需要确认存活人数和恶魔死亡方式；旅行者不计入人数。'] }),
  role({ id: 'yaggababble', name: '呓语魔', officialName: 'Yaggababble', team: 'demon', abilityText: 'You start knowing a secret phrase. For each time you said it publicly today, a player might die.', inputKinds: ['text', 'number'], possibleOutcomes: ['得知一个秘密短语。', '根据当天公开说出次数，可能有玩家死亡。'], stateChanges: ['可能造成一名或多名玩家死亡。'], highRiskNotes: ['公开短语次数由说书人记录；工具不能根据聊天自动判断杀人。'] }),
