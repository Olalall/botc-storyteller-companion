...
export const aGrimmChorusRoles: readonly SmartRoleDefinition[] = [
  ...
  role({ id: 'po', name: '珀', officialName: 'Po', team: 'demon', abilityText: 'Each night*, you may choose a player: they die. If your last choice was no-one, choose 3 players tonight.', inputKinds: ['text'], stateChanges: ['可选择不杀；若上一夜不杀，本夜必须选择三名玩家（不能再次空刀，也不能少选）。'], highRiskNotes: ['需要记录上一夜是否空刀；多目标死亡必须由说书人确认。', '如果珀在上一个夜晚不选择任何人时处于醉酒或中毒，当晚珀仍然能够选择三名玩家。'] }),
