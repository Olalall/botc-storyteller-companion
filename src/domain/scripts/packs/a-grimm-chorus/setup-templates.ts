...
export const aGrimmChorusSetupTemplates: readonly SetupTemplate[] = [
  ...
  template({ id: 'public-pressure', count: 7, style: 'balanced', roles: ['towncrier', 'innkeeper', 'gambler', 'exorcist', 'fisherman', 'scarletwoman', 'yaggababble'], bluffs: ['general', 'nightwatchman', 'soldier'], note: 'A Grimm Chorus 7 人均衡模板：白天话术和夜晚选择并重，牙噶巴卜只做暗号记录提醒。' }),
  ...
  template({ id: 'three-outsiders', count: 9, style: 'chaos', roles: ['towncrier', 'exorcist', 'amnesiac', 'fisherman', 'damsel', 'drunk', 'politician', 'godfather', 'yaggababble'], bluffs: ['general', 'gambler', 'cannibal'], note: 'A Grimm Chorus 9 人高压模板：三外来者和牙噶巴卜制造社交压力，暗号次数不自动结算。', godfatherAddsOutsider: true }),
  ...
  template({ id: 'no-outsider-godfather', count: 11, style: 'long-game', roles: ['general', 'towncrier', 'gambler', 'nightwatchman', 'slayer', 'soldier', 'minstrel', 'cannibal', 'godfather', 'assassin', 'yaggababble'], bluffs: ['villageidiot', 'innkeeper', 'exorcist'], note: 'A Grimm Chorus 11 人长线模板：教父移除外来者，牙噶巴卜的公开暗号次数由说书人记录。', godfatherRemovesOutsider: true }),
  ...
  template({ id: 'fourteen-clean', count: 14, style: 'balanced', roles: ['general', 'villageidiot', 'towncrier', 'innkeeper', 'gambler', 'exorcist', 'amnesiac', 'nightwatchman', 'fisherman', 'cannibal', 'godfather', 'assassin', 'scarletwoman', 'yaggababble'], bluffs: ['slayer', 'soldier', 'minstrel'], note: 'A Grimm Chorus 14 人长线模板：教父移除外来者，牙噶巴卜只提示暗号记录。', godfatherRemovesOutsider: true }),
