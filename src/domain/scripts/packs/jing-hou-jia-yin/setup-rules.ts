...
export const jingHouJiaYinSetupRules: readonly SetupRule[] = [
  { id: 'balloonist-extra-outsider', roleId: 'balloonist', summary: 'Balloonist adds 1 Outsider; excluded from first normal templates.', knowledgeStatus: 'confirmed', sourceUrls: [sourceUrl], reviewedAt },
  ...
  { id: 'plaguedoctor-st-minion-ability', roleId: 'plaguedoctor', summary: 'Plague Doctor death may give the storyteller an out-of-play Minion ability.', knowledgeStatus: 'confirmed', sourceUrls: [sourceUrl], reviewedAt },
