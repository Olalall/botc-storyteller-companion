...
export const devoutTheistsSetupTemplates: readonly SetupTemplate[] = [
  ...
  template({ id: 'fanggu-puzzle', count: 10, style: 'long-game', roles: ['chef', 'pixie', 'flowergirl', 'savant', 'juggler', 'cannibal', 'puzzlemaster', 'widow', 'psychopath', 'fanggu'], bluffs: ['noble', 'highpriestess', 'farmer'], note: 'Devout Theists 10 人方古模板：方古增加解谜大师，寡妇与精神病态者带来状态和公开死亡压力。', fangGuAddsOutsider: true }),
  ...
  template({ id: 'lleech-snitch', count: 12, style: 'chaos', roles: ['highpriestess', 'mathematician', 'amnesiac', 'fisherman', 'farmer', 'magician', 'cannibal', 'snitch', 'klutz', 'goblin', 'psychopath', 'lleech'], bluffs: ['noble', 'chef', 'pixie'], note: 'Devout Theists 12 人痢蛭伪装模板：告密者、哥布林和精神病态者强化白天风险。' }),
