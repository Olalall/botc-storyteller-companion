...
export const devoutTheistsRoles: readonly SmartRoleDefinition[] = [
  ...
  role({ id: 'klutz', name: '呆瓜', officialName: 'Klutz', team: 'outsider', abilityText: 'When you learn that you died, publicly choose 1 alive player: if they are evil, your team loses.', inputKinds: ['player'], possibleOutcomes: ['公开选择存活玩家。', '若目标邪恶，呆瓜的阵营落败。'], stateChanges: ['可能触发呆瓜阵营落败。'], highRiskNotes: ['死亡确认后才处理选择；胜负必须由说书人确认。', '特例：邪恶阵营的呆瓜选中邪恶玩家时，改为善良阵营获胜。'] }),
