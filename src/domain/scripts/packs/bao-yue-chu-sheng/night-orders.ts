...
export const baoYueChuShengOtherNight: readonly NightOrderEntry[] = [
  ...
  {"roleId": "shabaloth", "order": 27, "note": "上一夜被沙巴洛斯选择且当前已死亡的玩家之一可能被反刍，如果被反刍，标记那名玩家被复活。让沙巴洛斯选择两名玩家。标记这两名玩家死亡。", "knowledgeStatus": "confirmed"},
  ...
  {"roleId": "professor", "order": 45, "note": "教授可以选择一名死亡玩家。如果他这么做了，标记教授失去能力，然后如果那名玩家是镇民，标记那名玩家被复活。之后的夜晚无需再唤醒教授。", "knowledgeStatus": "confirmed"},
