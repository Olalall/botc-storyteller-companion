...
export const quickMathsRoles: readonly SmartRoleDefinition[] = [
  ...
  role({ id: 'alsaahir', name: '戏法师', officialName: 'Alsaahir', team: 'townsfolk', abilityText: 'Each day, if you publicly guess which players are Minion(s) and which are Demon(s), good wins.', inputKinds: ['players'], possibleOutcomes: ['公开猜中所有爪牙和恶魔：善良胜利。', '未猜中：无事发生。'], stateChanges: ['可能触发善良胜利。'], highRiskNotes: ['是否公开、是否完整命中和胜负必须由说书人确认。'] }),
  ...
  role({ id: 'xaan', name: '限', officialName: 'Xaan', team: 'minion', abilityText: 'On night X, all Townsfolk are poisoned until dusk. [X Outsiders]', inputKinds: ['number'], setupImpact: ['外来者数量为 X；第 X 夜所有镇民中毒到黄昏。'], stateChanges: ['第 X 夜所有镇民中毒到黄昏。'], highRiskNotes: ['X 与外来者数量绑定；中毒范围只做提醒，不能批量自动改状态。'] }),
  ...
  role({ id: 'boffin', name: '科学怪人', officialName: 'Boffin', team: 'minion', abilityText: 'The Demon (even if drunk or poisoned) has a not-in-play good character’s ability. You both know which.', inputKinds: ['role'], possibleOutcomes: ['恶魔获得一个不在场善良角色能力。'], identityChanges: ['恶魔额外拥有一个善良角色能力。'], highRiskNotes: ['恶魔获得能力只做提醒；不自动执行该善良角色状态机。'] }),
