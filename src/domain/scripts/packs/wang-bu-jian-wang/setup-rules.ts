...
export const wangBuJianWangSetupRules: readonly SetupRule[] = [
  ...
  { id: 'balloonist-extra-outsider', roleId: 'balloonist', summary: 'Balloonist adds 1 Outsider; kept out of first normal templates.', knowledgeStatus: 'confirmed', sourceUrls: [sourceUrl], reviewedAt },
