...
export const zhiShouZheTianOtherNight: readonly NightOrderEntry[] = [
  ...
  { roleId: "gossip", order: 46, note: "如果白天的声明为真，会有一名玩家死亡，并由说书人来选择一名玩家，标记该玩家死亡。", knowledgeStatus: 'confirmed' },
  { roleId: "farmer", order: 47, note: "如果农民在夜晚死去，则选择另一位善良玩家成为农民。唤醒这名玩家，并告知他成为了农民。", knowledgeStatus: 'confirmed' },
