...
export const bingGongBanShiRoles = [
  ...
  role({
    ...
    inputKinds: ["none"],
    highRiskNotes: ["哈迪寂亚可不选择；若选择，依次公开三名目标并让其秘密选择生死，每次选择立即结算。", "哈迪寂亚可以不进行选择：此时说书人不会宣布哈迪寂亚在场并选择玩家的播报，夜晚继续进行，当晚无人因此死亡。", "结算条件以百科为准：只看三名玩家在各自选择结算后是否全部存活（不看他们选了什么）——若都存活则都死亡；选择“死去”但受免死能力保护而存活的玩家也计入“都存活”；已死亡的玩家选择“活着”会被复活；哈迪寂亚醉酒或中毒时能力不产生任何效果，也不发播报。"],
  }),
  role({
    id: "qiongqi",
    name: "穷奇",
