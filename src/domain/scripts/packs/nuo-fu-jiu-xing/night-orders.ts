...
export const nuoFuJiuXingFirstNight: readonly NightOrderEntry[] = [
  ...
  { roleId: "butler", order: 8100, note: "让管家选择一名玩家。标记那名玩家为他的主人。提醒：流放表决不受主人限制，管家可自由参与表决。", knowledgeStatus: 'confirmed' },
...
export const nuoFuJiuXingOtherNight: readonly NightOrderEntry[] = [
  ...
  { roleId: "butler", order: 11200, note: "让管家选择一名玩家。标记那名玩家为他的主人。提醒：流放表决不受主人限制，管家可自由参与表决。", knowledgeStatus: 'confirmed' },
