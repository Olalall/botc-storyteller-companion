...
export const siDongFeiDongRoles: readonly SmartRoleDefinition[] = [
  ...
  role({ id: "pukka", name: "普卡", officialName: "Pukka", team: "demon", abilityText: "Each night, choose a player: they are poisoned. The previously poisoned player dies then becomes healthy.", inputKinds: ["player"], possibleOutcomes: ["May cause, prevent, or react to death depending on the confirmed source."], stateChanges: ["Death-related outcomes must be confirmed before state changes.", "May create poisoned, drunk, sober or healthy state."], identityChanges: ["May change character or gain/replace an ability."], playerMessageTemplates: ["You are now {role}."], highRiskNotes: ["Death, execution, protection and death source must not auto-apply.", "Poison/drunk state is a candidate result until storyteller confirms it.", "Identity changes affect later night order only after explicit confirmation."] }),
  ...
  role({ id: "bureaucrat", name: "官员", officialName: "Bureaucrat", team: "traveler", abilityText: "Each night, choose a player (not yourself): their vote counts as 3 votes tomorrow.", inputKinds: ["player"], possibleOutcomes: ["Record the choice or information result for storyteller confirmation."] }),
  ...
  role({ id: "barista", name: "咖啡师", officialName: "Barista", team: "traveler", abilityText: "Each night, until dusk, 1) a player becomes sober, healthy & gets true info, or 2) their ability works twice. They learn which.", inputKinds: ["none"], possibleOutcomes: ["Record the choice or information result for storyteller confirmation."], stateChanges: ["May create poisoned, drunk, sober or healthy state."], identityChanges: ["May change character or gain/replace an ability."], playerMessageTemplates: ["You are now {role}."], highRiskNotes: ["Poison/drunk state is a candidate result until storyteller confirms it.", "Identity changes affect later night order only after explicit confirmation."] }),
]
