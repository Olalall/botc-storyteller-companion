...
export const wuYinCangShengSetupRules: readonly SetupRule[] = [
  ...
  { id: 'barber-demon-swap', roleId: 'barber', summary: 'Barber death lets the Demon swap two players roles that night (not another Demon; the acting Demon may choose itself).', knowledgeStatus: 'confirmed', sourceUrls: [sourceUrl], reviewedAt },
