...
export const punchyRoles: readonly SmartRoleDefinition[] = [
  ...
  role({ id: 'huntsman', name: '猎人', officialName: 'Huntsman', team: 'townsfolk', abilityText: 'Once per game, at night, choose a living player: the Damsel, if chosen, becomes a not-in-play Townsfolk. [+the Damsel]', inputKinds: ['player'], setupImpact: ['开局加入落难少女，通常替换 1 名镇民。'], possibleOutcomes: ['若选中落难少女，目标变成一个不在场镇民。'], identityChanges: ['落难少女可能变成不在场镇民。'], playerMessageTemplates: ['你选择了{seat}号。'], highRiskNotes: ['救援成功后由说书人确认并追加身份更正。'] }),
  ...
  role({ id: 'spiritofivory', name: '象牙之灵', officialName: 'Spirit of Ivory', team: 'fabled', abilityText: "There can't be more than 1 extra evil player.", inputKinds: ['none'], setupImpact: ['额外邪恶玩家不能超过 1 名。'], possibleOutcomes: ['限制食人魔等额外邪恶变化。'], highRiskNotes: ['传奇角色只作为全局约束，不进入座位身份池，也不作为恶魔伪装。'] }),
]
