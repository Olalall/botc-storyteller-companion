...
export const punchySetupTemplates: readonly SetupTemplate[] = [
  ...
  template({ id: 'damsel-hunt', count: 7, style: 'balanced', roles: ['steward', 'huntsman', 'slayer', 'cannibal', 'damsel', 'cerenovus', 'ojo'], bluffs: ['pixie', 'general', 'princess'], note: 'Punchy 7 人猎人模板：落难少女信息链路清楚，洗脑师给白天压力。', huntsmanAddsDamsel: true }),
  ...
  template({ id: 'eight-social', count: 8, style: 'balanced', roles: ['steward', 'pixie', 'monk', 'savant', 'amnesiac', 'ogre', 'psychopath', 'pukka'], bluffs: ['general', 'slayer', 'alchemist'], note: 'Punchy 8 人社交模板：食人魔阵营变化不告知玩家，精神病态者只在白天公开记录。' }),
  template({ id: 'eight-damsel', count: 8, style: 'chaos', roles: ['balloonist', 'huntsman', 'slayer', 'cannibal', 'damsel', 'mutant', 'harpy', 'ojo'], bluffs: ['steward', 'pixie', 'princess'], note: 'Punchy 8 人落难少女模板：猎人和落难少女同局，鹰身女妖制造白天疯狂压力。', huntsmanAddsDamsel: true }),

  template({ id: 'nine-vigor', count: 9, style: 'balanced', roles: ['general', 'monk', 'savant', 'princess', 'cannibal', 'drunk', 'ogre', 'cerenovus', 'vigormortis'], bluffs: ['steward', 'pixie', 'balloonist'], note: 'Punchy 9 人维格莫提斯模板：基础 2 外来者，毒醉与死亡链路分开记录。' }),
  ...
  template({ id: 'ten-public-kill', count: 10, style: 'balanced', roles: ['steward', 'pixie', 'balloonist', 'general', 'monk', 'savant', 'slayer', 'harpy', 'psychopath', 'pukka'], bluffs: ['philosopher', 'princess', 'cannibal'], note: 'Punchy 10 人公开击杀模板：猎手和精神病态者都在白天制造公开事件，日志要分开记录。' }),
  ...
  template({ id: 'eleven-vigor-no-outsider', count: 11, style: 'long-game', roles: ['steward', 'balloonist', 'general', 'monk', 'savant', 'philosopher', 'princess', 'amnesiac', 'harpy', 'cerenovus', 'vigormortis'], bluffs: ['pixie', 'slayer', 'cannibal'], note: 'Punchy 11 人维格莫提斯模板：外来者被移除，邻座中毒只给提醒。', vigormortisRemovesOutsider: true }),
  ...
  template({ id: 'twelve-damsel-pressure', count: 12, style: 'chaos', roles: ['pixie', 'huntsman', 'savant', 'philosopher', 'alchemist', 'amnesiac', 'damsel', 'drunk', 'ogre', 'cerenovus', 'vizier', 'pukka'], bluffs: ['steward', 'balloonist', 'general'], note: 'Punchy 12 人落难少女模板：猎人救援、洗脑师疯狂和普卡链路都保持草稿确认。', huntsmanAddsDamsel: true }),
  template({ id: 'twelve-vigor', count: 12, style: 'long-game', roles: ['steward', 'pixie', 'balloonist', 'general', 'monk', 'savant', 'princess', 'cannibal', 'mutant', 'harpy', 'psychopath', 'vigormortis'], bluffs: ['philosopher', 'huntsman', 'alchemist'], note: 'Punchy 12 人维格莫提斯模板：移除 1 外来者，爪牙死亡后能力与中毒分开记录。', vigormortisRemovesOutsider: true }),
  ...
  template({ id: 'fifteen-vigor', count: 15, style: 'long-game', roles: ['steward', 'pixie', 'balloonist', 'general', 'monk', 'savant', 'philosopher', 'slayer', 'princess', 'cannibal', 'mutant', 'harpy', 'cerenovus', 'vizier', 'vigormortis'], bluffs: ['huntsman', 'alchemist', 'amnesiac'], note: 'Punchy 15 人维格莫提斯模板：减少外来者，公开爪牙和邻座中毒让主持记录更重要。', vigormortisRemovesOutsider: true }),
]
