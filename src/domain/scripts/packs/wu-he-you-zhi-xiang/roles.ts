...
export const wuHeYouZhiXiangRoles: readonly SmartRoleDefinition[] = [
  ...
  role({ id: "shugenja", name: "修行者", officialName: "Shugenja", team: "townsfolk", abilityText: "You start knowing if your closest evil player is clockwise or anti-clockwise. If equidistant, this info is arbitrary.", inputKinds: ["none"], possibleOutcomes: ["First night: learns whether the closest evil player is clockwise or anti-clockwise; if both sides are equidistant, the info shown is the Storyteller's choice."], highRiskNotes: ["Equidistant case is Storyteller discretion; do not auto-decide the direction."] }),
]
