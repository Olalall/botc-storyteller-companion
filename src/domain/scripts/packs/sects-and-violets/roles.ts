...
export const sectsAndVioletsRoles: readonly SmartRoleDefinition[] = [
  ...
  role({"id":"flowergirl","name":"卖花女孩","officialName":"Flowergirl","team":"townsfolk","abilityText":"Each night*, you learn if a Demon voted today.","inputKinds":["text"]}),
  role({"id":"towncrier","name":"城镇公告员","officialName":"Town Crier","team":"townsfolk","abilityText":"Each night*, you learn if a Minion nominated today.","inputKinds":["text"]}),
  ...
  role({"id":"seamstress","name":"女裁缝","officialName":"Seamstress","team":"townsfolk","abilityText":"Once per game, at night, choose 2 players (not yourself): you learn if they are the same alignment.","inputKinds":["players"],"possibleOutcomes":["两名目标同阵营。","两名目标不同阵营。"],"playerMessageTemplates":["是。","否。"],"highRiskNotes":["每局一次；同阵营判断受醉酒/中毒和登记异常影响。"]}),
  ...
  role({"id":"sweetheart","name":"心上人","officialName":"Sweetheart","team":"outsider","abilityText":"When you die, 1 player is drunk from now on.","inputKinds":["none"],"stateChanges":["心上人死亡后，一名玩家从此醉酒。"],"highRiskNotes":["醉酒目标由说书人选择并记录；死亡后持续。"]}),
  role({"id":"klutz","name":"呆瓜","officialName":"Klutz","team":"outsider","abilityText":"When you learn that you died, publicly choose 1 alive player: if they are evil, your team loses.","inputKinds":["none"],"possibleOutcomes":["死亡后公开选择一名存活玩家。","若目标邪恶，己方失败。"],"stateChanges":["可能触发阵营失败。"],"highRiskNotes":["不自动判负；目标阵营和结局由说书人确认。"]}),
  ...
  role({"id":"pithag","name":"麻脸巫婆","officialName":"Pit-Hag","team":"minion","abilityText":"Each night*, choose a player & a character they become (if not in play). If a Demon is made, deaths tonight are arbitrary.","inputKinds":["player","role"],"identityChanges":["目标可能变成一个不在场角色。"],"highRiskNotes":["如果制造了新恶魔，当晚死亡由说书人任意决定。"]}),
  role({"id":"eviltwin","name":"镜像双子","officialName":"Evil Twin","team":"minion","abilityText":"You & an opposing player know each other. If the good player is executed, evil wins. Good can't win if you both live.","inputKinds":["player","role"],"possibleOutcomes":["建立一对阵营相反的双子。"],"highRiskNotes":["善良双子被处决时邪恶获胜；双方存活时善良不能获胜。"]}),
  role({"id":"nodashii","name":"诺-达鲺","officialName":"No Dashii","team":"demon","abilityText":"Each night*, choose a player: they die. Your 2 Townsfolk neighbors are poisoned.","inputKinds":["none"],"possibleOutcomes":["夜晚选择一名玩家死亡。","两侧最近镇民邻座中毒。"],"stateChanges":["可能造成目标死亡；两侧最近镇民中毒。"],"highRiskNotes":["中毒邻座按当前座位和身份由说书人确认。"]}),
  ...
  role({"id":"vortox","name":"涡流","officialName":"Vortox","team":"demon","abilityText":"Each night*, choose a player: they die. Townsfolk abilities yield false info. Each day, if no-one is executed, evil wins.","inputKinds":["player"],"highRiskNotes":["镇民能力获得的信息必须为错误；不能由 AI 自动生成唯一答案。"]}),
  ...
  role({"id":"bonecollector","name":"集骨者","officialName":"Bone Collector","team":"traveler","abilityText":"Once per game, at night*, choose a dead player: they regain their ability until dusk.","inputKinds":["player"]}),
  role({"id":"deviant","name":"怪咖","officialName":"Deviant","team":"traveler","abilityText":"If you were funny today, you cannot die by exile.","inputKinds":["none"]}),
]
