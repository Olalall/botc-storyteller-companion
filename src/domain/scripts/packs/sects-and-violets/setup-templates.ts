...
export const sectsAndVioletsSetupTemplates: readonly SetupTemplate[] = [
  ...
  template({ id: "vigormortis-no-outsider", count: 11, style: "long-game", roles: ["snakecharmer","mathematician","dreamer","seamstress","philosopher","artist","juggler","sage","pithag","eviltwin","vigormortis"], bluffs: ["clockmaker","flowergirl","oracle"], note: "Sects & Violets / 梦殒春宵 11 人长线局模板；维格莫提斯外来者修正。", vigormortisRemovesOutsider: true }),
  ...
  template({ id: "vigormortis-wide", count: 14, style: "long-game", roles: ["clockmaker","snakecharmer","mathematician","dreamer","flowergirl","towncrier","oracle","savant","artist","sage","witch","pithag","eviltwin","vigormortis"], bluffs: ["seamstress","philosopher","juggler"], note: "Sects & Violets / 梦殒春宵 14 人长线局模板；维格莫提斯外来者修正。", vigormortisRemovesOutsider: true }),
