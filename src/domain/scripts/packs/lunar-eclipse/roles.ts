...
export const lunarEclipseRoles: readonly SmartRoleDefinition[] = [
  ...
  role({ id: 'harlot', name: '流莺', officialName: 'Harlot', team: 'traveler', abilityText: 'Each night*, choose a living player: if they agree, you learn their character, but you both might die.', inputKinds: ['player'], possibleOutcomes: ['若目标同意，流莺得知其角色；说书人可以裁量让两人在当晚一起死亡（与目标阵营无关）。'] }),
  role({ id: 'apprentice', name: '学徒', officialName: 'Apprentice', team: 'traveler', abilityText: 'On your 1st night, you gain a Townsfolk ability (if good), or a Minion ability (if evil).', inputKinds: ['role'], identityChanges: ['首夜时：如果学徒是善良的，获得一个镇民角色的能力；如果是邪恶的，获得一个爪牙角色的能力（通常为不在场角色）。'] }),
