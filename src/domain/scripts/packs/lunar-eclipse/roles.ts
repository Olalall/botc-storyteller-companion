...
export const lunarEclipseRoles: readonly SmartRoleDefinition[] = [
  ...
  role({ id: 'lycanthrope', name: '狼人', officialName: 'Lycanthrope', team: 'townsfolk', abilityText: 'Each night*, choose an alive player. If good, they die & the Demon doesn’t kill tonight. One good player registers as evil.', inputKinds: ['player'], possibleOutcomes: ['若目标为善良，目标死亡且恶魔今晚不杀人。'], stateChanges: ['一名善良玩家可能登记为邪恶。'], highRiskNotes: ['狼人目标、恶魔是否停刀和死亡结果都必须由说书人确认。'] }),
  ...
  role({ id: 'mayor', name: '市长', officialName: 'Mayor', team: 'townsfolk', abilityText: 'If only 3 players live & no execution occurs, your team wins. If you die at night, another player might die instead.', possibleOutcomes: ['夜晚死亡可能改为其他玩家死亡；三人白天无人处决可能善良胜利。'], highRiskNotes: ['胜负和转移死亡必须由说书人确认。'] }),
  ...
  role({ id: 'nodashii', name: '诺达鲺', officialName: 'No Dashii', team: 'demon', abilityText: 'Each night*, choose a player: they die. Your 2 Townsfolk neighbors are poisoned.', inputKinds: ['player'], stateChanges: ['两侧最近镇民中毒。'], highRiskNotes: ['中毒邻座按当前座位与身份由说书人确认。'] }),
  ...
  role({ id: 'harlot', name: '娼妓', officialName: 'Harlot', team: 'traveler', abilityText: 'Each night*, choose a living player: if they agree, you learn their character, but you both might die.', inputKinds: ['player'], possibleOutcomes: ['若目标同意，得知其角色；若目标邪恶，双方可能死亡。'] }),
  ...
  role({ id: 'spiritofivory', name: '象牙之灵', officialName: 'Spirit of Ivory', team: 'fabled', abilityText: "There can't be more than 1 extra evil player.", setupImpact: ['全局限制额外邪恶玩家不能超过 1 名。'], highRiskNotes: ['传奇角色不进入座位身份、模板或恶魔伪装。'] }),
]
