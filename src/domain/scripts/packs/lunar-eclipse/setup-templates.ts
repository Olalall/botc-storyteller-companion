...
export const lunarEclipseSetupTemplates: readonly SetupTemplate[] = [
  ...
  template({ id: 'eight-vigormortis', count: 8, style: 'long-game', roles: ['sailor', 'innkeeper', 'lycanthrope', 'savant', 'tealady', 'cannibal', 'assassin', 'vigormortis'], bluffs: ['grandmother', 'pixie', 'artist'], note: 'Lunar Eclipse 8 人维格莫提斯模板：无外来者，爪牙死亡后的中毒只做提醒。', vigormortisRemovesOutsider: true }),
  ...
  template({ id: 'ten-vigormortis-godfather', count: 10, style: 'chaos', roles: ['grandmother', 'pixie', 'sailor', 'chambermaid', 'savant', 'magician', 'cannibal', 'godfather', 'assassin', 'vigormortis'], bluffs: ['mathematician', 'innkeeper', 'artist'], note: 'Lunar Eclipse 10 人修正抵消模板：教父增加外来者、维格莫提斯减少外来者，两个提醒都保留。', godfatherAddsOutsider: true, vigormortisRemovesOutsider: true }),
  template({ id: 'eleven-social', count: 11, style: 'balanced', roles: ['grandmother', 'pixie', 'chambermaid', 'mathematician', 'innkeeper', 'artist', 'tealady', 'goon', 'spy', 'devilsadvocate', 'nodashii'], bluffs: ['sailor', 'lycanthrope', 'mayor'], note: 'Lunar Eclipse 11 人社交模板：莽夫阵营变化和诺达鲺中毒都需分开记录。' }),
  ...
  template({ id: 'twelve-vigormortis', count: 12, style: 'long-game', roles: ['grandmother', 'pixie', 'sailor', 'chambermaid', 'mathematician', 'innkeeper', 'savant', 'cannibal', 'goon', 'marionette', 'spy', 'vigormortis'], bluffs: ['artist', 'tealady', 'magician'], note: 'Lunar Eclipse 12 人维格莫提斯模板：外来者减少，提线木偶相邻和爪牙中毒都需人工核对。', vigormortisRemovesOutsider: true }),
  ...
  template({ id: 'thirteen-vigormortis-godfather', count: 13, style: 'chaos', roles: ['grandmother', 'sailor', 'lycanthrope', 'savant', 'tealady', 'magician', 'mayor', 'cannibal', 'artist', 'godfather', 'marionette', 'assassin', 'vigormortis'], bluffs: ['pixie', 'chambermaid', 'innkeeper'], note: 'Lunar Eclipse 13 人复杂模板：教父与维格莫提斯修正抵消，提线木偶必须邻恶魔。', godfatherAddsOutsider: true, vigormortisRemovesOutsider: true }),
  template({ id: 'fourteen-balanced', count: 14, style: 'balanced', roles: ['grandmother', 'pixie', 'sailor', 'chambermaid', 'mathematician', 'innkeeper', 'lycanthrope', 'artist', 'mayor', 'puzzlemaster', 'devilsadvocate', 'spy', 'assassin', 'nodashii'], bluffs: ['savant', 'tealady', 'magician'], note: 'Lunar Eclipse 14 人均衡模板：狼人、解谜大师和诺达鲺都需要状态提醒。' }),
  ...
  template({ id: 'fifteen-nodashii', count: 15, style: 'balanced', roles: ['grandmother', 'pixie', 'sailor', 'chambermaid', 'mathematician', 'innkeeper', 'lycanthrope', 'savant', 'magician', 'lunatic', 'puzzlemaster', 'devilsadvocate', 'spy', 'assassin', 'nodashii'], bluffs: ['artist', 'tealady', 'mayor'], note: 'Lunar Eclipse 15 人诺达鲺模板：中毒邻座、疯子和解谜大师醉酒都只做提示。' }),
